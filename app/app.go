...
import (
	...
	janetamodule "janeta/x/janeta"
	janetamodulekeeper "janeta/x/janeta/keeper"
	janetamoduletypes "janeta/x/janeta/types"
...
type App struct {
	*baseapp.BaseApp
	...
	JanetaKeeper janetamodulekeeper.Keeper
...
func New(
	...
	app.JanetaKeeper = *janetamodulekeeper.NewKeeper(
		appCodec,
		keys[janetamoduletypes.StoreKey],
		keys[janetamoduletypes.MemStoreKey],
		app.GetSubspace(janetamoduletypes.ModuleName),
	)
	janetaModule := janetamodule.NewAppModule(appCodec, app.JanetaKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(janetamoduletypes.ModuleName)
